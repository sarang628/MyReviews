...
public abstract class Hilt_MyReviewsFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MyReviewsFragment() {
    super();
  }

  Hilt_MyReviewsFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MyReviewsFragment_GeneratedInjector) this.generatedComponent()).injectMyReviewsFragment(UnsafeCasts.<MyReviewsFragment>unsafeCast(this));
    }
  }
